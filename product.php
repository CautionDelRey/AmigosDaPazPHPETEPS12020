...
<head>
	...
	<title>Administação de Postagem</title>
</head>
...
<!-- Card Geral -->	
	<div class="container">
		...
		<div class="card mt-5 p-5 shadow-lg mb-5">
			...
			<br>
			<p>      Informe se sua instituição precisa de produtos (ex. fraudas, produtos de higiene, alimentos) para o funcionamento de sua instituição, caso sua instituição precise de voluntário, escreva sobre isso também. Escreva detalhadamente sobre eles.</p>
			<p>Após o cadastrado destas informações, elas estarão disponíveis para visualização e exclusão no seu perfil.</p>
			<hr>
			...
			<form class="form-group" action="OrganController.php" method="POST">
				<div class="row">
					<div class="col-md-8">
						<h4>Produto:</h4>
						<p>Nesse espaço você escreve o nome do produto, tamanho, quantidade, marca entre outros detalhes pertinentes. Defina bem o produto para que fique de melhor entendimento para quem for ler.</p>
			...
			<form class="form-group" action="OrganController.php" method="POST">
				<div class="row">
					<div class="col-md-8">
						<h4>Voluntário:</h4>
						<p>Nesse espaço você deve descrever que tipo de serviço está sendo necessário,  dando detalhes precisos e pertinentes para que o voluntário saiba detalhadamente para o que ele possivelmente possa se voluntariar.</p>
						<label>Tipo de Serviço:</label>
						<input type="text" class="form-control" name="title">
					</div>
					<div class="col-md-8">
						<label>Detalhes sobre o serviço:</label>
						<textarea class="form-control" name="description" style="height: 200px;"></textarea>
					</div>
				</div>
